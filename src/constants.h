...
//Constants to hold various game settings such as screen size, 
//frames per second, etc.  Screen size not be constant in the near future.
...
const int LETTER_WIDTH = 40;
const int LETTER_HEIGHT = 40;
